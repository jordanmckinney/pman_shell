...
### Functions
	...
	pstat <pid>
		...
		Prints data about given PID. Prints comm, state, utime, stime, rss, voluntary context switches and involuntary context switches. See assignment outline for details on these fields. 
